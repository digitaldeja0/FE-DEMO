  ...
  return (
    <div className="masterDiv">
      ...
      <div className="mainDiv">
        <div className="mainText" id="item1">
      ...
      {/* Item2 */}
      <div className="mainDiv">
        <div className="mainText" id="item2">
      ...
      {/* Item3 */}
      <div className="mainDiv">
        <div className="mainText" id="item3">
